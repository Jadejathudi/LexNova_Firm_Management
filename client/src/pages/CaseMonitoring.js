      ...
      <div style={{ background: 'linear-gradient(135deg,#0B1237,#1B2559)', padding: '40px 48px 28px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
            ...
            <h1 style={{ color: '#fff', fontFamily: 'Georgia, serif', fontSize: '30px', fontWeight: 700, margin: 0 }}>Case Monitoring & Nudges</h1>
          </div>
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', padding: '28px 24px' }}>
        {!user ? (
          <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: '16px', padding: '48px 24px', textAlign: 'center' }}>
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 700, color: NAVY, marginBottom: '8px', fontFamily: 'Georgia, serif' }}>Sign in to view your nudges</h3>
          ...
          <>
            {/* How it works */}
            <div style={{ background: 'linear-gradient(135deg,#1B2559,#263580)', borderRadius: '16px', padding: '22px', marginBottom: '20px' }}>
