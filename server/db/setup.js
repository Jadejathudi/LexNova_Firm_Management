...
async function setup() {
  ...
  await sql`INSERT INTO advocates (advocate_id,user_id,bar_number,experience_years,specializations,state,city,bio,languages,rating,review_count,success_rate,cases_handled,is_verified,is_available) VALUES (${adv5Id},${seniorAdv3Id},'DL/9012/2012',10,${JSON.stringify(['real_estate','arbitration'])},'Delhi','New Delhi','Expert in real estate and arbitration law.',${JSON.stringify(['English','Hindi'])},4.7,30,80,95,1,1)`;
  await sql`INSERT INTO advocates (advocate_id,user_id,bar_number,experience_years,specializations,state,city,bio,languages,rating,review_count,success_rate,cases_handled,is_verified,is_available) VALUES (${adv6Id},${juniorAdv3Id},'DL/1234/2020',3,${JSON.stringify(['civil','real_estate'])},'Delhi','New Delhi','New advocate in civil and real estate law.',${JSON.stringify(['English','Hindi'])},4.4,8,70,25,1,1)`;
